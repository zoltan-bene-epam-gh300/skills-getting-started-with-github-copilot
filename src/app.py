...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice and play matches with the school soccer team",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["ryan@mergington.edu", "lily@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Train skills and scrimmage with fellow basketball players",
    ...
    "Drama Club": {
        "description": "Rehearse and perform plays, improv, and stage productions",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["eva@mergington.edu", "ben@mergington.edu"]
    }
}
